 ...
 *  Explication de la fonction : la fonction va allouer notre tableau et
 * initaliser chaque varible d'une variable de type LevelFile (concrètement
 * ligne et colonne) Retour : renvoie le level entièrement initaliser
 */
 ...
 *  Explication de la fonction : va créer une variable path qui va contenir le
 * chemin vers le level qui à son nom stocker dans filename Retour : retournele
 * chemin
 */
...
/*
 *  Nom : nbColFinder
 *  Précondition : le fichier doit être accessible en lecture et avoir la même
 * longueur pour chaque ligne sinon la fonction renverra possiblement une valeur
 * fausse Effet de bord : aucun Argument :
 *     - filename : nom de fichier
 *  Explication de la fonction : la fonction va cherche le nombre d'element dans
 * la premièrme ligne du fichier Retour : va renvoyer nbColonne qui signifie le
 * nombre d'élement dans la première ligne
 */
 ...
 *  Argument :
 *     - filename : nom de fichier
 *  Explication de la fonction : La fonction va chercher le nombre de retour a
 * la ligne qu'il y a dans le fichier Retour : renvoie le nb de retour a la
 * ligne dans le fichier de nom filename
 */
 ...
 *  Explication de la fonction : initalise une variable de type Level* en
 * fonction des caractéristique du fichier (qui a le nom stocker pour filename)
