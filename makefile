...
#Lance le script shell permettant de créer l'archive.
#Problème : Il faudrait refaire le code directement dans le makefile, je n'ai pas réussi du à des problèmes 
#avec les variables 
archive : 
	./archive.sh
